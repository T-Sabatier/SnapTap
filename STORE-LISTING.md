# Fiche Play Store Snap Tap (textes validés)

À coller dans Play Console. Règle d'écriture : jamais de tirets cadratins.

## Titre (30 caractères max)

```
Snap Tap : jeu de soirée
```

## Description courte (80 caractères max)

```
Plutôt pastis ou bubble tea ? Devine ce que tes amis aiment... ou détestent.
```
...
• 3 à 16 joueurs, parties de 15 à 30 minutes
• Aucun compte à créer, on joue en 30 secondes

👍 J'AIME, 👎 J'AIME PAS
Flaire les goûts des autres pour placer la bonne carte au bon moment. Premier à 5 points, victoire.

🃏 300+ CARTES, 20 CATÉGORIES
Bouffe, Ciné, Musique, Voyages, Boulot, Absurde... des catégories pour toutes les ambiances, activables par l'hôte du salon.
...
Tes amis n'ont pas l'app ? Ils peuvent rejoindre depuis leur navigateur. Mais c'est mieux avec l'app. 😉
```
...
- Classification IARC : DÉCIDÉ (14/07/2026) → on assume le 18+. Remplir
  honnêtement : références sexuelles explicites (Coquin) + références à
  l'alcool (Mode Apéro / Boisson). Une seule app, pas de version soft.
  Positionnement « jeu d'apéro pour adultes »
- Interactions utilisateurs : OUI (pseudos visibles entre joueurs d'un salon)
- Deck : 304 cartes, 20 catégories (dont Mode Apéro + 7 catégories du Pack Ultra)
- Assets déjà produits : captures d'écran, bannière 1024x500, icône 512x512
```
