...
### Pour le carrousel « comment on joue » (store-assets/promo/carousel/, 5 slides dans l'ordre)

```
Le principe en 3 étapes. Tu crois connaître tes potes, le jeu vérifie. Gratuit, sans compte, lien en bio.
```
