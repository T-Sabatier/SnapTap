...
const GENERIC_DEFIS = {
  fr: [
    ...
    '@Chante le générique d\'une sitcom, ou ressers tout le monde (même l\'eau)',
    ...
    '@Bras de fer de pouces contre ton voisin de droite, le perdant garde les mains sur la tête jusqu'à son prochain point',
    ...
    '@Concours de virelangues avec ton voisin de droite, la table juge',
    ...
    '@Imite le gagnant pendant 10 secondes, il note sur 10',
    // Votes qui piquent
  ...
  en: [
    ...
    '@Sing a sitcom theme song, or refill everyone's drink (water counts)',
    ...
    '@Thumb war against the player on your right, loser keeps their hands on their head until their next point',
    ...
    '@Tongue twister contest with the player on your right, the table judges',
    ...
    '@Impersonate the winner for 10 seconds, they rate it out of 10',
