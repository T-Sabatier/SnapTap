...
const GENERIC_GAGES = {
  fr: [
    ...
    'Tout le monde trinque, le dernier à reposer son verre boit 2 gorgées',
    "Ceux qui n'ont pas encore marqué de point boivent 2 gorgées",
    'Les voisins du gagnant boivent 2 gorgées',
    "Le gagnant choisit quelqu'un : il boit 3 gorgées",
    'Vote : le plus susceptible de finir sous la table boit 2 gorgées',
    'Le plus jeune de la table boit 2 gorgées',
    'Ceux qui ont leur tel à moins de 30% boivent 2 gorgées',
    'Tout le monde boit 1 gorgée à la santé du gagnant',
    'Le dernier à lever la main boit 2 gorgées',
  ],
  en: [
    'The winner hands out 3 sips',
    'Everyone cheers, the last to put their glass down drinks 2 sips',
    "Anyone who hasn't scored yet drinks 2 sips",
    "The winner's neighbors drink 2 sips",
    'The winner picks someone: they drink 3 sips',
    'Vote: the most likely to end up under the table drinks 2 sips',
    'The youngest at the table drinks 2 sips',
    'Anyone with their phone under 30% drinks 2 sips',
    'Everyone drinks 1 sip to the winner',
    'The last to raise their hand drinks 2 sips',
  ],
};
