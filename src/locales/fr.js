...
export const fr = {
  ...
  game: {
    ...
    winnerReadyIn: 'À toi dans {s} s…',
    winnerAfterChrono: 'À toi après le chrono…',
  ...
  debats: {
    ...
    classic: 'Classique',
    classicDesc: 'Devine ce que le boss aime',
    name: 'Débats',
    desc: 'Oui ou non ? La minorité prend cher',
    option: 'Option',
    soft: 'Soft',
    softDesc: 'Clivant mais pour tout le monde',
    adult: 'Adulte',
    adultDesc: 'Sexe, tabous, révélations · 18+',
    count: 'Nombre de questions',
    countHint: '{n} questions dans la partie',
    guestBanner: 'Mode Débats · {option}',
    ageTitle: 'Option Adulte',
    ageText:
      "Questions sur le <b>sexe</b>, les <b>tabous</b> et des <b>révélations</b> entre vous. Réservé aux <b>18 ans et plus</b> : tout le monde à table est majeur ?",
    ageYes: "Oui, on a tous 18 ans",
    ageNo: 'Annuler',
    rules: [
      '• Une question tombe, chacun répond <b>OUI ou NON</b> en secret',
      "• On révèle : le camp <b>minoritaire</b> prend une marque 🐑",
      '• À <b>3 marques</b> : MOUTON NOIR !',
    ],
    rulesApero: '• Le mouton noir <b>boit 2 gorgées</b>',
    question: 'Question {i}/{n}',
    yes: 'Oui',
    no: 'Non',
    voted: '{n}/{total} ont répondu',
    changeVote: 'Tu peux encore changer',
    revealNow: 'Révéler maintenant',
    minority: 'Minorité · +1 🐑',
    tie: 'Égalité · personne ne prend',
    unanimous: 'Unanimité !',
    nobody: 'Personne',
    debate: 'Débattez !',
    next: 'Question suivante',
    finish: 'Voir les résultats',
    waitNext: '{name} lance la suite',
    moutonKicker: '🐑 Mouton noir',
    moutonApero: '2 gorgées !',
    moutonAperoMany: '2 gorgées chacun !',
    moutonNormal: '3 fois contre tout le monde',
    marks: 'Tes marques',
    endTitle: 'Fin du débat',
    mostMouton: '🐑 Le plus mouton noir',
    leastMouton: '🐏 Le plus dans le moule',
