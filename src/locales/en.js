...
export const en = {
  ...
  game: {
    ...
    playedBy: 'Played by',
    voteFor: 'Vote for:',
    defiAnnounce: 'Challenge!',
    whoGetsIt: "Who's up?",
    chronoStart: 'Start the timer ({s}s)',
    chronoUp: "Time's up!",
    chronoStop: 'Host: tap to stop',
    yourTurnNext: 'Your turn! What do you want?',
    winnerReadyIn: 'Your turn in {s}s…',
    winnerAfterChrono: 'Your turn after the timer…',
    winnerWillStart: '{name} starts the next round',
  ...
  debats: {
    gameMode: 'Game mode',
    classic: 'Classic',
    classicDesc: 'Guess what the boss likes',
    name: 'Debates',
    desc: 'Yes or no? The minority pays',
    option: 'Option',
    soft: 'Soft',
    softDesc: 'Divisive but for everyone',
    adult: 'Adult',
    adultDesc: 'Sex, taboos, confessions · 18+',
    count: 'Number of questions',
    countHint: '{n} questions this game',
    guestBanner: 'Debates mode · {option}',
    ageTitle: 'Adult option',
    ageText:
      'Questions about <b>sex</b>, <b>taboos</b> and <b>confessions</b> about each other. <b>18+ only</b>: is everyone at the table an adult?',
    ageYes: "Yes, we're all 18+",
    ageNo: 'Cancel',
    rules: [
      '• A question drops, everyone answers <b>YES or NO</b> in secret',
      '• Reveal: the <b>minority</b> side gets a mark 🐑',
      '• <b>3 marks</b>: BLACK SHEEP!',
    ],
    rulesApero: '• The black sheep <b>drinks 2 sips</b>',
    question: 'Question {i}/{n}',
    yes: 'Yes',
    no: 'No',
    voted: '{n}/{total} answered',
    changeVote: 'You can still change',
    revealNow: 'Reveal now',
    minority: 'Minority · +1 🐑',
    tie: 'Tie · nobody takes one',
    unanimous: 'Unanimous!',
    nobody: 'Nobody',
    debate: 'Debate!',
    next: 'Next question',
    finish: 'See results',
    waitNext: '{name} starts the next one',
    moutonKicker: '🐑 Black sheep',
    moutonApero: '2 sips!',
    moutonAperoMany: '2 sips each!',
    moutonNormal: '3 times against everyone',
    marks: 'Your marks',
    endTitle: 'Debate over',
    mostMouton: '🐑 Biggest black sheep',
    leastMouton: '🐏 Most in line',
