export const DEFAULT_CARDS = [
  ...
  ['Coup de foudre', 'relations'], ['Slow burn', 'relations'],
  ['Mariage', 'relations'], ['PACS', 'relations'],
  ['Saint-Valentin', 'relations'], ['Cadeau surprise', 'relations'],
  ...
  ['Les Marseillais', 'culture'], ["Les Ch'tis", 'culture'],
  ['Hanouna', 'culture'], ['Quotidien', 'culture'], ['Squeezie', 'culture'],
  ['Inoxtag', 'culture'], ['McFly & Carlito', 'culture'], ['Norman', 'culture'],
  ['Hugo Décrypte', 'culture'], ['Brut', 'culture'], ['Mister V', 'culture'],
